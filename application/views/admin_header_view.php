...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/css/jquery.formstyler.css'?>" media = 'screen'>
	...
	<div class = "container">
		<div class = "navbar-header">
			...
			<a class="navbar-brand" href = "#" style = "margin-top: -5px;">
				<img src = "<?php echo base_url()?>assets/images/brand.png" width = 30 height = 30 alt = "">
			</a>
		</div>
		...
		<div class = "collapse navbar-collapse" id = "main-header-menu">
			...
			<form action = "<?php echo base_url()?>index.php/admin/do_logout" method = "POST" class = "navbar-form navbar-right" role = "logout">				
